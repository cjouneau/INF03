<!-- à modifier en ajoutant la possibilité de paramétrer-->
<?php
    if($_GET['tru']==1)
    {
...
?>
    ...
    <title>Validation de votre inscription à la newsletter du cours "Approche Utilisateur et Desing Web"</title>
